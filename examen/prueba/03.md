##  Dado el archivo 03.xml que guarda los libros de una librerí­a, comprados y pendientes de recibir. Se pide realizar las siguientes consultas Xpath: 

1. Lista los autores de los libros en ingles y el nombre del autor comience por la letra P. 
...
se emplea or, ya que si se pone AND tendrÃ­a que aparecer en ambas listas(comprado y pendiente) para que aparezca en el resultado 
-->
...
4. Tí­tulo de los libros con más de un autor. 
